...
export class FacebookApiService {
  ...
  fetchAlbum(): Observable<any> {
    const url = `https://graph.facebook.com/v22.0/${this.pageId}?fields=name,picture,feed.limit(4){message,attachments{media,subattachments},created_time}&access_token=${this.accessToken}`
